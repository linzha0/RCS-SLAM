...
int main(int argc, char** argv) {
    ...
    // ======================================================================//
    {
        ...
        range = (sqrt(pow(p1.x() - p2.x(),2) + pow(p1.y() - p2.y(),2)));
        if(range >= commdist) {
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1000, 2000, commdist, commNoise));
            // printf("agent1-2: pair 0\n");
        }
    ...
    if (one_hop){
        ...
        if (range > 2*commdist) {  
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1000, 3000, 2*commdist, onehopNoise));
        }
        ...
        if (range > 2*commdist) {  
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1001, 3001, 2*commdist, onehopNoise));
        }
        else if (range < commdist) {
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
        ...
        if (range > 2*commdist) {  
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1002, 3002, 2*commdist, onehopNoise));
        }
        else if (range < commdist) {
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
        ...
        if (range > 2*commdist) {  
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1003, 3003, 2*commdist, onehopNoise));
        }
        else if (range < commdist) {
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
        ...
        if (range > 2*commdist) {  
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1004, 3004, 2*commdist, onehopNoise));
        }
        else if (range < commdist) {
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
        ...
        if (range > 2*commdist) {  
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
                1005, 3005, 2*commdist, onehopNoise));
        }
        else if (range < commdist) {
            graph.add(gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>(
